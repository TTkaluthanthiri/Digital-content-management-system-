            ...
            <div class="col-xl-12 col-lg-7">
              <div class="card shadow mb-4">
                <div class="card-header d-flex flex-row  breadcr" >
                  ...
                  <span class="bread"><a href="#">Items</a></span>
                ...
                <div class="card-body" >
                  <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                      <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#tocom" role="tab" aria-controls="nav-home" aria-selected="true">To Complete</a>
                      <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#pend" role="tab" aria-controls="nav-profile" aria-selected="false">Pending</a>
                      <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#com" role="tab" aria-controls="nav-profile" aria-selected="false">Completed</a>
                      <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#dis" role="tab" aria-controls="nav-profile" aria-selected="false">Disqualified</a>
                  ...
                  <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="tocom" role="tabpanel" aria-labelledby="nav-home-tab">
                      <div class="text-center">
                        <h4>To Complete</h4>
                        This section includes all the orders yet to be completed.
                        <br><br>
                      </div>

                      <small>Ahead</small><hr>
                        ...
                        <ul class="ct-contact-list">
                          <li>
                            <div class="ct-contact list-light">
                              <div class="row">
                                <div class="col">
                                  <span class="ct-txt-highlight">[ORDER NAME]</span> for <span class="ct-txt-highlight">[CUSTOMER]</span> 
                                  ...
                                  <div class="text-center">
                                    <form>
                                      <div class="form-group">
                                        <input class="btn vrn-success" type="file"/>
                                      </div>
                                    </form>
                                  </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col">
                                  <div class="text-center">
                                    <!-- Custom Cards -->
                                    <small>Contact using following options</small>
                      ...
                      <small>Exceeded</small><hr>
                    </div>
                    <div class="tab-pane fade" id="pend" role="tabpanel" aria-labelledby="nav-home-tab">
                      <div class="text-center">
                        <h4>Pending</h4>
                        This section includes all uncomfirmed files that required customers' approval to complete transaction.
                        <br><br>
                      </div>
                      <hr>
                      <div class="ct-list-container">
                    ...
                    <div class="tab-pane fade" id="com" role="tabpanel" aria-labelledby="nav-home-tab">
                      COMPLETED
                    </div>
                    <div class="tab-pane fade" id="dis" role="tabpanel" aria-labelledby="nav-home-tab">
                      DISQUALIFIED
                    </div>
                  </div>
