                  ...
                  <div class="row">
                    <div class="col">
                      <div class="ct-title-container">
                        <h1 class="ct-special">WE ARE<br><span class="ct-font-green">UNSTOPABLE</span> </h1>
                      ...
                      <div class="ct-title-container">
                        <p id="exec-dec">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the 
                          ...
                          <p id="exec-dec">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the 
                            ...
                            Ipsum.</p>
                          <br>  
                          <h4 class="ct-font-green">DEVELOPERS</h4>  
                          <p id="exec-dec">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the 
                            industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it 
                          ...
                          <div class="row">
                            <div class="col">
                              <div class="ct-accpic account" id="account-pic"></div>
                              <div class="text-center">
                                <h5 class="ct-font-green">Buddima</h5>
                            ...
                            <div class="col">
                              <div class="ct-accpic account" id="account-pic"></div>
                              <div class="text-center">
                                <h5 class="ct-font-green">Terrants</h5>
                                <small>Developer</small>
                              </div>
