            ...
            <div class="col-xl-12">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <p>Add a Item and enter details related to the item.</p>
                  <a target="_blank" rel="nofollow" href="https://undraw.co/">Continue Adding item &rarr;</a>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div class="row">
                    <div class="col">
                      ...
                      <div class="form-group">
                        ...
                        <small id="custHelp" class="form-text text-muted">Explain further about item's category</small>
                      </div>

                      <div class="form-group">
                        <label for="itemCat">Pricing (Rs.)</label>
                        <select class="form-control" id="itemPrice">
                          <option>500</option>
                          <option>1000</option>
                          <option>1500</option>
                          <option>2500</option>
                        ...
                        <small id="custHelp" class="form-text text-muted">Give a price for your Item</small>
                      </div>
                      
                      <div class="form-group">
                        <label for="formControlRange">Mark yor Price</label>
                        <input type="range" class="form-control-range" id="itemPriceR" max="100000" min="500">
                      </div>

                      <div class="form-group">
                        <label for="itemCat">Number of Items</label>
                        <select class="form-control" id="itemQTY">
                          <option>No Coverup included</option>
                        ...
                        <small id="custHelp" class="form-text text-muted">Give a estimated price for additional coverups</small>
                      </div>
                      <div class="form-group">
                        <label for="formControlRange">Mark yor Price</label>
                        <input type="range" class="form-control-range" id="itemPriceAddR" max="100000" min="500">
                      </div>
                    </div>

                    <div class="col">
                      <div class="form-group">
                        <label for="itemPurpose">Purpose of Item</label>
                        <input type="text" class="form-control" id="itemPurpose" aria-describedby="purposeHelp">
